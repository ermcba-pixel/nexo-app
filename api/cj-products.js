...
function searchProfile(q){
  ...
  const profiles = {
    ...
    'calcetin':{query:'socks', any:['sock','socks','hosiery','ankle sock','crew sock'], es:'calcetín'},
    'calcetines':{query:'socks', any:['sock','socks','hosiery','ankle sock','crew sock'], es:'calcetines'},
    'media':{query:'socks', any:['sock','socks','hosiery','stocking','stockings'], es:'media'},
    'medias':{query:'socks', any:['sock','socks','hosiery','stocking','stockings'], es:'medias'},
