...
export default async function handler(req,res){
  ...
  try{
    ...
    await rest('pagos', {method:'POST', body:JSON.stringify([{pedido_id, cliente_id, metodo:pedidoRow.metodo_pago, estado:pedidoRow.estado_pago, monto_usd:total, moneda:'USD', proveedor:firstProvider, agente_responsable:'agente1', metodo_pago_cliente:pedidoRow.metodo_pago, redireccion_externa:isAmazon, amazon_tag:isAmazon?'nexo08-20':null}])}).catch(()=>{});
